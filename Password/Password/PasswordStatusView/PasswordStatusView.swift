...
//  Password
//
//  Created by Hummingbird on 31/07/2025.
//
...
extension PasswordStatusView {
    ...
    func style() {
       ...
       // stackView.distribution = .equalCentering // distribute equally in the predefined box
    ...
    func layout() {
        ...
        NSLayoutConstraint.activate([
            ...
            //bottomAnchor.constraint(equalToSystemSpacingBelow: stackView.bottomAnchor, multiplier: 2) // MARK: Comment this out to make them start top center of the box
        ])
    }
